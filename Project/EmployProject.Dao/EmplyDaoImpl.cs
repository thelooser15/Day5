...
namespace EmployProject.Dao
{
    public class EmployDaoImpl : iEmployDao
    {
        ...
        {
            FileStream fs = new FileStream(@"D:\Git Wipro Practice\wiprodata\Employ.txt", FileMode.Open, FileAccess.Read);
        ...
        {
            FileStream fs = new FileStream(@"D:\Git Wipro Practice\wiprodata\Employ.txt", FileMode.Create, FileAccess.Write);
            BinaryFormatter formatter = new BinaryFormatter();
